<!DOCTYPE html>
<html>
<!-- /contact-us/ Fri, 29 Aug 2025 18:53:16 GMT -->
...
<head>
	...
	<meta property="og:url" content="https://eliteflyerbd.com/contact-us/">
	...
	<div class="container">
		...
		<div class="contact__form_container">
			<div class="contact__top_content">
					...
					<h3 class="title_2">Phone</h3>
					<p><a href="tel:+61450596920">+61 450 596 920</a></p>
				</div>
												<div class="contact__col">
					<h3 class="title_2">Email</h3>
					<p><a href="mailto:info@eliteflyerbd.com">info@eliteflyerbd.com</a></p>
				</div>
											</div>
			<div class="contact__bottom_content">
				<div class="contact__form">
					<form action="#" autocomplete="off">
						<h3 class="title_2">Get in Touch</h3>
						<input type="text" placeholder="Your Name*" class="name" name="feedback_user_name" value>
						<input type="email" placeholder="Email Address*" class="email" name="feedback_user_email" value>
						<textarea placeholder="Message*" class="message" name="feedback_user_message" value></textarea>
						<input type="submit" class="white_button -black" value="Send">
					</form>
				</div>
							</div>
		</div>
...
<!-- /contact-us/ Fri, 29 Aug 2025 18:53:17 GMT -->
</html>
